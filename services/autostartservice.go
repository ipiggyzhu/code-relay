...
<dict>
	<key>Label</key>
	<string>com.coderelay.app</string>
...
func (as *AutoStartService) getDarwinPlistPath() string {
	...
	return filepath.Join(home, "Library", "LaunchAgents", "com.coderelay.app.plist")
}
...
func (as *AutoStartService) getLinuxDesktopPath() string {
	...
	return filepath.Join(configHome, "autostart", "coderelay.desktop")
}
